...
function testValidObjectLiteral() {
    ...
    Assert.throwsErrors(()=>{ validObjectLiteral(new String(''), 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(new String('ssss'), 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(123, 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(new Number(123), 'xxx', false); }, VerificationError);
    ...
    Assert.throwsErrors(()=>{ validObjectLiteral(new Boolean(true), 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(new Boolean(false), 'xxx', false); }, VerificationError);
    ...
    Assert.throwsErrors(()=>{ validObjectLiteral(new Map(), 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(new Map([['a', 12], ['b', 13]]), 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(new Set(), 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(new Set([1,2,3]), 'xxx', false); }, VerificationError);
    Assert.throwsErrors(()=>{ validObjectLiteral(/123/, 'xxx', false); }, VerificationError);
