...
function testAutoVnAofObjectLiteral() {
    ...
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new String(''), true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new String('ssss'), true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(123, true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new Number(123), true, descObj); }, VerificationError);
    ...
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new Boolean(true), true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new Boolean(false), true, descObj); }, VerificationError);
    ...
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new Map(), true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new Map([['a',1],['b',2]]), true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new Set(), true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new Set([1,2,3]), true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(/123/, true, descObj); }, VerificationError);
    Assert.throwsErrors(()=>{ autoVnAofObjectLiteral(new RegExp('123'), true, descObj); }, VerificationError);
